...
val scaleFactors = Seq("1", "10", "100") // "1", "10", "100", "1000", "10000" list of scale factors to generate and import

val baseLocation = s"s3a://mhb-dev-bucket/spark-sql-perf/" // S3 bucket, blob, or local root path
